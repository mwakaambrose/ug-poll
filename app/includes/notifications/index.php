<html>
    <head>
        <title>AgriPoll | Push Notification</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div class="container">
            <div class="fl_window">
                <div><img src="http://www.technoplusug.com/agripollnew.png" width="200" alt="Firebase"/></div>
                <br/>
                <?php if ($json != '') { ?>
            ...
            <form class="pure-form pure-form-stacked" method="get">
                <fieldset>
                    <legend>Send to a Single Extension Worker</legend>
